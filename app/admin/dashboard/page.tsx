...
export default function AdminDashboardPage() {
  ...
  const counts = {
    ...
    unresolved: messages.filter((m) => m.status !== 'resolved').length,
  }
      ...
      <main className="flex-1 mx-auto w-full max-w-6xl px-6 py-8">
        ...
        {filtered.length === 0 ? (
          <div className="rounded-2xl border border-line bg-card p-12 text-center">
            <p className="font-fraunces text-xl italic text-ink-soft mb-1">
              No messages here.
            </p>
                    ...
                    <>
                      ...
                      >
                        ...
                        <td className="px-5 py-3.5 align-top">
                          ...
                          <p className="text-xs text-ink-soft mt-0.5 break-all">
                            {msg.email ?? '—'}
                          </p>
                        </td>
